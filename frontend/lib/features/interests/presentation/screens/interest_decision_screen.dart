...
class InterestDecisionScreen extends ConsumerWidget {
  ...
  Future<void> _respond(BuildContext context, WidgetRef ref, bool accept,
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
          duration: const Duration(seconds: 3),
          content: Text('Interest accepted — you can now chat.')),
    );
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                        '${record.profile.profession} · ${record.profile.city}',
                        textAlign: TextAlign.center,
                        style: context.textStyles.bodyMedium
                            ?.copyWith(color: context.colors.muted)),
                    ...
                    TextButton(
                      onPressed: () => context
                          .push(AppRoutes.profileDetailPath(record.profile.id)),
                      ...
                      children: [
                        Expanded(
                          child: OutlinedButton(
                            onPressed: () => _respond(
                                context, ref, false, record.profile.id),
                        ...
                        Expanded(
                          child: ElevatedButton(
                            onPressed: () =>
                                _respond(context, ref, true, record.profile.id),
